...
public class CustomerRepositoryTests {
	...
	public void setUp() {
		...
		dave = repository.save(new Customer("Dave", "Matthews","0841113700"));
		oliver = repository.save(new Customer("Oliver August", "Matthews","0841113700"));
		carter = repository.save(new Customer("Carter", "Beauford","0841113700"));
	}

	@Test
	public void setsIdOnSave() {

		Customer dave = repository.save(new Customer("Dave", "Matthews","0841113700"));
	...
	public void findsByExample() {
		...
		Customer probe = new Customer(null, "Matthews","0841113700");
